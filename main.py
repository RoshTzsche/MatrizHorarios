...
class SchoolSchedulerApp:
    def __init__(self, root):
        ...
        self.root.geometry("1000x800") # Un poco más grande para mejor visualización
        ...
        # Binding de evento: Detectar cambio de pestaña
    ...
    def on_tab_change(self, event):
        """
        Manejador de eventos: Se dispara cada vez que el usuario cambia de pestaña.
        Verifica si la pestaña actual es la visual y actualiza el grid.
        """
    ...
    def create_visual_tab(self):
        ...
        # Botón Exportar (Ahora vive aquí)
    ...
    # ... (MANTÉN LOS MÉTODOS create_crud_tab Y create_requirements_tab IGUAL QUE ANTES) ...
    ...
    def create_run_tab(self):
        ...
        # Modificado: Solo genera, no exporta automáticamente
    ...
    def render_grid(self):
        ...
        # Estilos de colores (Inspiración Solarized para terminal lovers)
        COLOR_HEADER = "#eee8d5"
        COLOR_BUSY = "#859900" # Green
        COLOR_FREE = "#fdf6e3" # Base3
    ...
    def on_cell_click(self, time, room):
        ...
        if data:
            ...
            ttk.Label(popup, text="(Edición manual para agregar clases\npendiente de implementación)", font=("Arial", 8)).pack(pady=5)
...
if __name__ == "__main__":
    ...
    # Intento de mejorar la estética en Linux
    try:
        style.theme_use('clam') 
    except:
        pass
        
    # Colores personalizados para el Treeview y Notebook
